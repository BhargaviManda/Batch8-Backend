...
//	
    ...
    void testGetAllBatchNamesWithIdsWhenBatchesNotEmpty() {
        // Mocking data
        List<Batch> batches = new ArrayList<>();
        Batch batch1 = new Batch(1L, "Batch A", "Description A", 10, LocalDate.of(2024, 4, 1), LocalDate.of(2024, 4, 30), List.of(101L, 102L), 50);
        Batch batch2 = new Batch(2L, "Batch B", "Description B", 15, LocalDate.of(2024, 5, 1), LocalDate.of(2024, 5, 31), List.of(103L, 104L), 60);
        batches.add(batch1);
        batches.add(batch2);
    ...
    void testUpdateEndDateWhenBatchExists() {
        ...
        Batch batch = new Batch(batchId, "Batch A", "Description", 10, LocalDate.of(2024, 4, 1),
                endDate, null, 50);
